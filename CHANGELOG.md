...
## Fork Changes (kimny1143/claude-code-action@beta)
...
- **Updated Base Action**: Uses `kimny1143/claude-code-base-action@beta` which includes OAuth credential handling
